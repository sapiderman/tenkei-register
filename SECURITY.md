...
* **Social Engineering:** No phishing staff or members, because we are not fish.
* **DDoS:** Do not attempt to flood our services (Cloudflare and Google Cloud don't like it either).
...
As Tenkei Aikidojo is a non-profit organization run by volunteers, we currently **do not offer financial rewards or bug bounties** for vulnerability reports. We deeply appreciate the time and effort of security researchers who help keep our community safe, and we are happy to provide public acknowledgment or recommendations for valid, impactful reports. There may be cookies or tiramisu, depending on the baker.
